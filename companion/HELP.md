...
- LastBackCueTime / LastForwardCueTime / LastBlackoutCueTime: Shows the time of day the last cue of the given type was triggered
- LastBackCueInterval / LastForwardCueInterval / LastBlackoutCueInterval: Shows the interval value from the V7 of the last cue of the given type was triggered
...
- RegisteredHandsets : Array of handset IDs currently registered to the system
